/// @function text_rich_fade_in_words
/// @description Fade in text word by word
...
function text_rich_fade_in_words(_delay_per_word, _duration, _delay_per_char, _initial_delay) {
	...
	text_rich_animate_words(TransformValue.alpha, 0, 1, _duration, ease_quad_out, _delay_per_word, _delay_per_char, _initial_delay);
