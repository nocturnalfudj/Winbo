...
/// @summary Animate a transform value from start to target over time.
function transform_animate(_transform,_transform_value,_start,_target,_time_current,_time_max,_curve,_recoil,_curve_is_ease_function) {
