/// @function text_rich_fade_in
/// @description Fade text in character by character
...
function text_rich_fade_in(_delay_per_char, _duration, _initial_delay) {
	...
	text_rich_animate_characters(TransformValue.alpha, 0, 1, _duration, ease_linear, _delay_per_char, _initial_delay);
