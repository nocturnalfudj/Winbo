/// @function vignette_noise_setting_set_current
/// @summary Update the active vignette noise settings.
/// @param _inner_circle_size Inner radius of the effect.
/// @param _outter_circle_size Outer radius of the effect.
/// @param _noise_strength Strength of the noise overlay.
function vignette_noise_setting_set_current(_inner_circle_size,_outter_circle_size,_noise_strength){
	var _setting;
