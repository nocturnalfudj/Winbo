/// @function transform_animate_from_current
/// @summary Animate a transform from its current value to a target.
function transform_animate_from_current(_transform,_transform_value,_target,_time_current,_time_max,_curve,_recoil,_curve_is_ease_function) {
