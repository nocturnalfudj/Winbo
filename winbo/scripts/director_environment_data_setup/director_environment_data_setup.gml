function director_environment_data_setup(){
	...
	#region Presence
		...
		environment[_environment] = new EnvironmentData(
			...
			_environment_foreground,
			[
				{mode: "normal", sprite: spr_bg_presence_layer_4, parallax_x: 0.0, parallax_y: 0.0, offset_y: 0, repeat_x: false, clamp_y: false},
				{mode: "normal", sprite: spr_bg_presence_layer_3, parallax_x: 0.0, parallax_y: 0.0, offset_y: 0, repeat_x: false, clamp_y: false},
				{mode: "normal", sprite: spr_bg_presence_layer_2, parallax_x: 0.0, parallax_y: 0.0, offset_y: 0, repeat_x: false, clamp_y: false}
			],
			[
				{mode: "normal", sprite: spr_bg_presence_layer_1_foreground, parallax_x: 0.0, parallax_y: 0.0, offset_y: 0, repeat_x: false, clamp_y: false}
			]
		);
		with(environment[_environment]){
