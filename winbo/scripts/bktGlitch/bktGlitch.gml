...
function bktglitch_init() {
	...
	*/
	...
	if (! shader_is_compiled(sh_bkt_glitch)) {
	    sdm("bktGlitch failed to compile, the effect will not be visible.");
	    return 0;
	}
	...
	global.bktGlitchUniform[bktGlitch.lineSpeed] = shader_get_uniform(sh_bkt_glitch, "lineSpeed");
	global.bktGlitchUniform[bktGlitch.lineDrift] = shader_get_uniform(sh_bkt_glitch, "lineDrift");
	global.bktGlitchUniform[bktGlitch.lineResolution] = shader_get_uniform(sh_bkt_glitch, "lineResolution");
	global.bktGlitchUniform[bktGlitch.lineVertShift] = shader_get_uniform(sh_bkt_glitch, "lineVertShift");
	global.bktGlitchUniform[bktGlitch.lineShift] = shader_get_uniform(sh_bkt_glitch, "lineShift");   
	global.bktGlitchUniform[bktGlitch.jumbleness] = shader_get_uniform(sh_bkt_glitch, "jumbleness"); 
	global.bktGlitchUniform[bktGlitch.jumbleResolution] = shader_get_uniform(sh_bkt_glitch, "jumbleResolution");   
	global.bktGlitchUniform[bktGlitch.jumbleShift] = shader_get_uniform(sh_bkt_glitch, "jumbleShift");  
	global.bktGlitchUniform[bktGlitch.jumbleSpeed] = shader_get_uniform(sh_bkt_glitch, "jumbleSpeed");    
	global.bktGlitchUniform[bktGlitch.dispersion] = shader_get_uniform(sh_bkt_glitch, "dispersion");
	global.bktGlitchUniform[bktGlitch.channelShift] = shader_get_uniform(sh_bkt_glitch, "channelShift"); 
	global.bktGlitchUniform[bktGlitch.noiseLevel] = shader_get_uniform(sh_bkt_glitch, "noiseLevel");   
	global.bktGlitchUniform[bktGlitch.shakiness] = shader_get_uniform(sh_bkt_glitch, "shakiness");
	global.bktGlitchUniform[bktGlitch.rngSeed] = shader_get_uniform(sh_bkt_glitch, "rngSeed");
	global.bktGlitchUniform[bktGlitch.intensity] = shader_get_uniform(sh_bkt_glitch, "intensity"); 
	global.bktGlitchUniform[bktGlitch.time] = shader_get_uniform(sh_bkt_glitch, "time");   
	global.bktGlitchUniform[bktGlitch.resolution] = shader_get_uniform(sh_bkt_glitch, "resolution");
	global.bktGlitchUniform[bktGlitch.noiseTexture] = shader_get_sampler_index(sh_bkt_glitch, "noiseTexture");
	global.bktGlitchUniform[bktGlitch.randomValues] = shader_get_uniform(sh_bkt_glitch, "randomValues");
...
/// @description Passes time variable to the shader, needs to change for animation.
/// @param {real} _time
function bktglitch_set_time(_time) {
	/*
