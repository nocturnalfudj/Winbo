/// @function text_button_step
/// @summary Per-frame logic for interactive text buttons.
/// @returns {void}
function text_button_step() {
	//State Switch
	switch(state){
		...
		case UIState.idle:
			text_button_state_idle();
		break;
	
		case UIState.hover:
			text_button_state_hover();
		break;
	
		case UIState.down:
			text_button_state_down();
		break;
	
		case UIState.active:
			text_button_state_active();
		break;
