...
function presence_dialogue_pages_create(_stage) {
	switch(_stage) {
		case "level_3":
			return [
				presence_dialogue_page("They fear you because they#can not understand you,#Winbo.", 3),
				presence_dialogue_page("They want you to be like#them. They want you to have#lore.", 3),
				presence_dialogue_page("For so great a sin there can#be no punishment too#severe.", 3),
				presence_dialogue_page("Jump on their heads, Winbo.#Jump on all of their heads.", 2),
			];

		case "level_5":
			return [
				presence_dialogue_page("You have likely surmised by#now, Winbo.", 2),
				...
				presence_dialogue_page("Release them from their#myopic ambition.", 2),
				presence_dialogue_page("Give them the violence they#so crave.", 2),
			];
		...
		case "bonus":
			return [
				...
				presence_dialogue_page("Your reward for gathering all#the Talismans.", 2),
				presence_dialogue_page("The deed is done, Winbo,#but perhaps our job is not.", 2),
				presence_dialogue_page("Does your wish to purge#these lands remain?", 2),
				presence_dialogue_page("Are you satisfied?", 1),
				presence_dialogue_page("Or do the embers of rage#still crackle within your#rattling soul?", 3),
	...
	return [
		...
		presence_dialogue_page("With their guns and bombs#and internal conflict.", 2),
