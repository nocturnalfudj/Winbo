...
function presence_dialogue_pages_create(_stage) {
	...
	return presence_dialogue_pages_prepare([
		presence_dialogue_page("Look upon these|charlatans, Winbo.|With their guns", 3),
		presence_dialogue_page("and bombs and|internal conflict.|So self-important", 3),
		presence_dialogue_page("are they that they|pay no mind to|whose domain this", 3),
		presence_dialogue_page("once was until he|stands before|them. Collect my", 3),
		presence_dialogue_page("Talismans and|humble them,|remind them of", 3),
		presence_dialogue_page("whence they|came. This is your|nature, Winbo.", 3),
		presence_dialogue_page("You collect things.|Now go, strip|them of all their", 3),
		presence_dialogue_page("pretences. Strip|them of all that|they are.", 3),
	]);
}
