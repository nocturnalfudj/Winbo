...
function director_draw_parallax_layer_frame(_sprite, _frame, _camera_x, _camera_y, _camera_width, _camera_height, _parallax_x, _parallax_y, _offset_y, _clamp_top = true, _clamp_bottom = true) {
