function cmd_instance_object_move_gravity_fall(_subject,_argument_list) {
	...
	with(_subject){
		if(variable_instance_exists(id,"move_gravity_fall")){
			move_gravity_fall.Set(_gravity_x,_gravity_y);
			
			sdm("Instance " + string(id) + " gravity fall set to " + string(_gravity_x) + "," + string(_gravity_y),LOG_COLOUR_COMMAND_SUCCESS);
		}
		else{
