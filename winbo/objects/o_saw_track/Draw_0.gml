...
var _draw_xscale = (saw_track_width / _source_width) * sign(image_xscale);
var _draw_yscale = (saw_track_height / _source_height) * sign(image_yscale);
...
if(image_angle != 0 || image_xscale < 0 || image_yscale < 0){
	...
	draw_sprite_stretched_ext(sprite_current,0,x,y,saw_track_width,saw_track_height,image_blend,image_alpha);
}
