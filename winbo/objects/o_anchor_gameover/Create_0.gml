...
#region Menu Creation
	...
	_x = 0;
	_y = 0;
	instance_create_layer(_x,_y,"lyr_pause_back",o_fade_gameover);
	
	//Title
	_x = 0;
	_y = 400;
	with(instance_create_layer(_x,_y,"lyr_pause",o_txtPstr_gameover_title)){
	...
	_x = 0;
	_y = -400;
	with(instance_create_layer(_x,_y,"lyr_pause",o_txtPstr_gameover_continue)){
