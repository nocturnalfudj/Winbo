...
//Colour
transform_set(transform[TransformType.anchor],TransformValue.colour,c_flat_yellow_energy_yellow);
...
//Appear
transform_animate_grow_and_appear(0.3*SECOND,ease_back_out);
transform_animate_from_current_relative(transform[TransformType.anchor],TransformValue.y,-100,0,SECOND*2,ease_quad_in,false,true);

#region State Scripts
	state_script[UIState.create][UIStateStage.main] = ui_game_create_main;
	
	state_script[UIState.idle][UIStateStage.main] = txtPstr_bump_idle_main;
#endregion
