...
//Toggle
toggle_enable = true;
button_toggle_set(o_camera.vignette_noise_enable);
...
#region Text
	#region Title
		...
		title_text = noone;
		title_string = "Vignette System Toggle";
...
#region State Scripts
	...
	state_script[UIState.active][UIStateStage.main] = btn_vignette_enable_active_main;
#endregion