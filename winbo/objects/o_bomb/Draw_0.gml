if(camera_visible){
	//Draw Actor
	draw_sprite_ext(sprite_current,sprite_current_frame,x,y,image_xscale,image_xscale,image_angle,image_blend,image_alpha);
	
	#region Flash
		if(flash_alpha > 0){
			shader_set(sh_monochrome);
			draw_sprite_ext(sprite_current,sprite_current_frame,x,y,image_xscale,image_xscale,image_angle,flash_colour,flash_alpha);
			shader_reset();
		}
	#endregion
