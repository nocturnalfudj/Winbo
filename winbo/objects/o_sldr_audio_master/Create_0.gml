...
#region Text
	...
	#region Title
		title_text = new Text(TextGroup.ui,221); // "Master"
...
#region State Scripts
	...
	state_script[UIState.idle][UIStateStage.main] = sldr_audio_master_idle_main;

	state_script[UIState.active][UIStateStage.main] =  sldr_audio_master_active_main;
	state_script[UIState.down][UIStateStage.stop] =  sldr_audio_master_down_stop;
#endregion