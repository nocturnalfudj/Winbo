...
var _points_str = (_score.points_deaths > 0) ? ("+" + string(_score.points_deaths)) : ((_score.points_deaths == 0) ? "+0" : string(_score.points_deaths));
text_string = string(_score.deaths) + " (" + _points_str + " Points)";
font = fnt_default_42;
