	...
	switch(bar_direction){
		case BarDirection.up:
			...
			if(edge_sprite!=noone)
				draw_sprite_ext_ags(edge_sprite,0,0,_scale_y,_scale_x,_gui_scale,0,_colour,_alpha);
		break;
		...
		case BarDirection.down:
			...
			if(edge_sprite!=noone)
				draw_sprite_ext_ags(edge_sprite,0,0,_y,_scale_x,-_gui_scale,0,_colour,_alpha);
		break;
		...
		case BarDirection.left:
			...
			if(edge_sprite!=noone)
				draw_sprite_ext_ags(edge_sprite,0,_scale_x,0,-_scale_y,_gui_scale,90,_colour,_alpha);
		break;
		...
		case BarDirection.right:
			...
			if(edge_sprite!=noone)
				draw_sprite_ext_ags(edge_sprite,0,_x,0,_scale_y,_gui_scale,-90,_colour,_alpha);
		break;
	}
