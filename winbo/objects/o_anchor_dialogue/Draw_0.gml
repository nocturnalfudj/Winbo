...
switch(presence_dialogue_page_line_count) {
	case 1:
		...
		_text_offset_y = presence_dialogue_text_center_y_small;
	break;

	case 2:
		_box_sprite = spr_presence_speech_box_medium;
		_text_offset_y = presence_dialogue_text_center_y_medium;
	break;

	default:
		_box_sprite = spr_presence_speech_box_large;
		_text_offset_y = presence_dialogue_text_center_y_large;
	break;
}
...
if(presence_dialogue_ready_for_advance && presence_dialogue_page_index < array_length(presence_dialogue_pages) - 1) {
	var _prompt_y;
	_prompt_y = _presence_y + 50 * presence_dialogue_box_scale;
