...
//Colour
transform_set(transform[TransformType.anchor],TransformValue.colour,c_flat_green_malachite);
...
#region State Scripts
	...
	state_script[UIState.idle][UIStateStage.main] = txtPstr_heal_idle_main;
#endregion

//Light
lighting_light_create_track(spr_light_circular,c_flat_green_malachite,"lyr_lighting",0.5,0.5,0,0,0,1);